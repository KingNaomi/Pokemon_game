...
# A fancy styling introduction of Dominique & Naomi using colour and font symbols.
print('\33[33m\33⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚\33[0m')  # \33[33m\33 = changes text colour. 33m is yellow.
print('')
print('         \33[30m\33[43m  DOMINIQUE & NAOMI \33[0m       ')  # 30m = black font, 43m = yellow background box
print('         \33[33m\33POKEMON TRUMPS GAME \33[0m    ')
print('')
print('\33[33m\33⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚⊚\33[0m', '\n')  # \n = Means make a new line
time.sleep(2)  # This delays for the next line to pop up in 2 seconds.
...
def delay(s):  # This is to make the text move slow. Shown on line 94.
    for c in s:
        sys.stdout.write(c)
        sys.stdout.flush()
...
def run():
    ...
    while True:  # 'While True' functions helps to start a new game again if user still wants to keep playing.
        print('Would you like to enter the pokemon you want or get a random pokemon? Please type "enter or random" ')
        ...
        if enter_random == 'random':  # if user inputs to get a 'random' Pokemon, a random Pokemon will be selected.
            ...
            if user_stat > enemy_stat:  # If user stat number is higher than enemy, adds 1 point to the winner.
                ...
                print('You Won! Well done. \U0001F606')
        ...
        # A new loop will appear to play the game.
            ...
            if enter_random == 'random':
                ...
                if user_stat > enemy_stat:
                    winner += 1
                    print('Your {} is higher.'.format(stat_choice))
                    print('Your the winner! \U0001F606')
